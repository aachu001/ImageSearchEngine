...
urlpatterns = [
    path('', include('search.urls')), # search is the name of the application
    ...
    path('password_change/done/', auth_views.PasswordChangeDoneView.as_view(template_name='passwords/password_change_done.html'), name='password_change_done'),
